...
const displayOllamaSettings = (containerEl: HTMLElement, plugin: QuizGenerator, refreshSettings: () => void, showAdvanced?: boolean): void => {
	const advanced = showAdvanced ?? false;
	
	// Ollama base URL is essential (no API key needed) - always show
